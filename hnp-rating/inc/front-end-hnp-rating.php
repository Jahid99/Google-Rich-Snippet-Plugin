...
if (!function_exists('get_web_page_ratings_amazonzz'))   {

function get_web_page_ratings_amazonzz( $url )
{
    $options = array(
...
$string = trim(get_web_page_ratings_amazonzz($profile_link2));
...
$flag='';
  ...
  $ebay_ratings = array_sum($flag)/20;
...
$total_ratings+=(float)sprintf('%.2f',$ebay_ratings);
$total_reviews+=(float)$ebay_reviews;
...
if(isset($profile_link4)){
  ...
  function curl_download_anwalt($Url){
   ...
   $anwalt_reviews = curl_download_anwalt($profile_link4);
 ...
 if (!function_exists('curl_download_anwalt2'))   {
  function curl_download_anwalt2($Url){
   ...
   $anwalt_ratings = curl_download_anwalt2($profile_link4);
...
$total_ratings+=(float)$anwalt_ratings;
$total_reviews+=(float)$anwalt_reviews;
...
$total_ratings+=(float)sprintf('%.1f',$aerzte_ratings);
$total_reviews+=(float)$aerzte_reviews;
...
$flag='';
    ...
    $jameda_ratings = ($reverseRating - 1.0) / 5.0 * 4.0 + 1.0;
...
<?php
    ...
    $total_ratings+=(float)sprintf('%.1f',$jameda_ratings);
    $total_reviews+=(float)sprintf('%.1f',$jameda_reviews);
...
//     $ratings1 = trim($flag);
    ...
    $tripadvisor_reviews = (int) filter_var($flag, FILTER_SANITIZE_NUMBER_INT);


    $total_ratings+=(float)sprintf('%.1f',$tripadvisor_ratings);
    $total_reviews+=(float)sprintf('%.1f',$tripadvisor_reviews); ?>
...
if(isset($profile_link8)){
   ...
   $total_ratings = (round($total_ratings/$i,2));
    ...
    echo "<p class='prof_reviews'>".$total_reviews." Bewertungen im Gesamtbewertungen</p>";

 ?>

 <p class="prof_ratings"><?php echo $total_ratings ; ?> von 5 Sternen </p><br>
...
if(isset($profile_link)){
   ...
   <p class="prof_ratings"><?php echo $facebook_ratings; ?> von 5 Sternen </p><br>
...
if(isset($name1)){
 ...
 <p class="prof_ratings"><?php echo $google_ratings; ?> von 5 Sternen </p><br>
...
if(isset($profile_link2)){
    ...
    <p class="prof_ratings"><?php echo $amazon_ratings; ?> von 5 Sternen </p><br>
<?php }


if(isset($profile_link3)){
    echo "<p class='prof_reviews'>".$ebay_reviews." Bewertungen auf <a href='".$profile_link3."' target='_blank'> ebay.com</a></p>"; ?>
    <p class="prof_ratings"><?php echo sprintf('%.2f',$ebay_ratings) ; ?> von 5 Sternen </p><br>
<?php }


if(isset($profile_link4)){ ?>
    <p class="prof_reviews"><?php echo $anwalt_reviews ; ?> Bewertungen auf <a href="<?php echo $profile_link4; ?>" target="_blank">Anwalt.de</a> </p>
    <p class="prof_ratings"><?php echo  $anwalt_ratings; ?> von 5 Sternen </p><br>
<?php }

if(isset($profile_link5)){
    echo "<p class='prof_reviews'>".$aerzte_reviews." Bewertungen auf <a href='".$profile_link5."' target='_blank'> aerzte.de</a></p>"; ?>
     <p class="prof_ratings"><?php echo sprintf('%.1f',$aerzte_ratings) ; ?> von 5 Sternen </p><br>
<?php }

if(isset($profile_link6)){
    echo "<p class='prof_reviews'>".$jameda_reviews." Bewertungen auf <a href='".$profile_link6."' target='_blank'> jameda.de</a></p>"; ?>
    <p class="prof_ratings"><?php echo sprintf('%.1f',$jameda_ratings) ; ?> von 5 Sternen </p><br>
<?php }

if(isset($profile_link8)){
     echo "<p class='prof_reviews'>".$tripadvisor_reviews." Bewertungen auf <a href='".$profile_link8."' target='_blank'> tripadvisor.com</a></p>"; ?>
     <p class="prof_ratings"><?php echo $tripadvisor_ratings; ?> von 5 Sternen </p><br>
<?php }
